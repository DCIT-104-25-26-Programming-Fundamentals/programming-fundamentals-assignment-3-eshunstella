 ...
 * @returns {string|null} The letter grade ("A"-"F"), or null if the
 *                         score is out of the valid 0-100 range.
 */
...
/**
 * Reads a score from the user, determines the grade,
 * and prints the result (or an error if out of range).
 */
function main() {
